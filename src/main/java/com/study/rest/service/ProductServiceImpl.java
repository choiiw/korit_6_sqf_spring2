...
//        return CommonResponseDto.ofDefault(successCount);
    ...
    @Override
    public CommonResponseDto registerColor(ReqRegisterColorDto reqRegisterSizeDto) {
        return CommonResponseDto.ofDefault(colorMapper.save(reqRegisterSizeDto.toEntity()));
    }
    }
